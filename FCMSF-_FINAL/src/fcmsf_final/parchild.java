 ...
 * @author asus
 */
public class parchild extends javax.swing.JFrame {

    /**
     * Creates new form PARCHILD
     */
    public parchild() {
        initComponents();
    ...
    private void initComponents() {
        ...
        main.add(jLabel1);
        jLabel1.setBounds(220, 150, 160, 30);

        jLabel3.setFont(new java.awt.Font("Arial Black", 0, 18)); // NOI18N
        jLabel3.setText("CHILD NAME");
        main.add(jLabel3);
        jLabel3.setBounds(220, 300, 140, 30);

        jLabel5.setFont(new java.awt.Font("Arial Black", 0, 18)); // NOI18N
        jLabel5.setText("PID");
        main.add(jLabel5);
        jLabel5.setBounds(1100, 150, 120, 30);

        jLabel6.setFont(new java.awt.Font("Arial Black", 0, 18)); // NOI18N
        jLabel6.setText("CID");
        main.add(jLabel6);
        jLabel6.setBounds(1100, 300, 120, 30);

        ed.setFont(new java.awt.Font("Arial Black", 0, 18)); // NOI18N
        ed.setText("TERM_END");
        main.add(ed);
        ed.setBounds(1100, 460, 120, 30);

        strt.setFont(new java.awt.Font("Arial Black", 0, 18)); // NOI18N
        strt.setText("TERM_START");
        main.add(strt);
        strt.setBounds(210, 480, 170, 26);
        main.add(start);
        start.setBounds(380, 480, 120, 30);
        main.add(end);
        end.setBounds(1220, 460, 120, 30);
        main.add(pnt);
        pnt.setBounds(400, 150, 120, 30);
        main.add(cnt);
        cnt.setBounds(400, 300, 120, 30);
        main.add(pt);
        pt.setBounds(1220, 150, 120, 30);
        main.add(ct);
        ct.setBounds(1220, 300, 120, 30);

        su.setBackground(new java.awt.Color(0, 0, 0));
        su.setFont(new java.awt.Font("Arial Black", 0, 18)); // NOI18N
        su.setForeground(new java.awt.Color(0, 204, 204));
        su.setText("SUBMIT");
    ...
    private void suActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suActionPerformed
     String PNAME=pnt.getText();
            String CNAME=cnt.getText();
            String PID=pt.getText();
            String CID=(String)ct.getText();
            SimpleDateFormat dFormat=new  SimpleDateFormat("yyyy-MM-dd");
            String DOB=dFormat.format(start.getDate());   
             String DOB1=dFormat.format(end.getDate());   
            try{
                Connection con=FCMSF_FINAL.getCon();
                Statement st=con.createStatement();
                st.executeUpdate("insert into parchild(P_NAME,C_NAME,PID,CID,TERM_START,TERM_END) values(' "+PNAME+" ',' "+CNAME+"','"+PID+"','"+CID+"','"+DOB+"','"+DOB1+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(parchild.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel strt;
