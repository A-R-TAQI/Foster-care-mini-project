...
public class org extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        otable.setBackground(new java.awt.Color(153, 255, 255));
        otable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "OID", "ORG_NAME", "PHONE", "CITY", "ORG_TYPE"
            }
        ));
        jScrollPane1.setViewportView(otable);

        main.add(jScrollPane1);
        jScrollPane1.setBounds(520, 190, 560, 110);
    ...
    private void shoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shoActionPerformed
        ...
        try{
            ...
            while(rs.next()){
                ...
                String tbData[]={OID,ORG_NAME,PHONE,CITY,ORG_TYPE};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(org.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
