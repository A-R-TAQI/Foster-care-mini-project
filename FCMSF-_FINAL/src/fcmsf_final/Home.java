...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        content.setFont(new java.awt.Font("Arial Black", 1, 20)); // NOI18N
        content.setForeground(new java.awt.Color(255, 255, 0));
        content.setText("<html> <pre>     At X we’re raising funds and promoting initiatives to serve the people who need them most.<br>We believe in taking action with urgency in order to raise public awareness about some of the<br>most pressing issues facing today’s fostercare system.Please join us by supporting our efforts<br>to make a measurable difference in the lives of both foster parents and foster children.</pre>  <pre>           </pre> <pre>                              X is achieving so much more with our initiatives than ever before!<br>                          We are working on many exciting projects to help improve the lives of<br>                          our Gems,and are very proud of the progress we're continuing to make.Learn more about what<br>                          we do, whom we help, and how we work every day to promote positive change.</pre> <pre>     </pre> <pre >                              With this initiative, we are seeking to provide prospective foster parents with the<br>                          information and resources needed to successfully become foster parents.With access to the<br>                          right resources, anyone can become empowered by their abilities <br>                          and gain the desire to fulfill their potential as new foster<br>                          parents.</pre> <pre>     </pre> <pre>                              With this initiative, we will strive to promote confidence<br>  and enrich hope and love into our fostered youth. They are the future, so we must ensure<br>  our future shines! With access to an abundance of resources and guidance in the correct<br>  direction, our gems can become whatever they choose be..the sky's the limit!!              </html>");
        content.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        main.add(content);
        content.setBounds(130, 100, 1410, 700);

        header.setBackground(new java.awt.Color(255, 255, 255));
        header.setFont(new java.awt.Font("Arial Black", 0, 18)); // NOI18N
        header.setForeground(new java.awt.Color(255, 255, 0));
        header.setText("<html>   <pre>                        Working Today to Provide a Brighter Tomorrow For Our Foster Families</pre>   <p>  \n       </html>");
        header.setToolTipText("");
        header.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        main.add(header);
        header.setBounds(130, 50, 1410, 50);

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/pexels-tima-miroshnichenko-6321637 (1).jpg"))); // NOI18N
        main.add(background);
