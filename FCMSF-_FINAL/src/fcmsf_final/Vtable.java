 ...
 * @author asus
 */
public class Vtable extends javax.swing.JFrame {

    /**
     * Creates new form Vtable
     */
    public Vtable() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(512, 105, 590, 500);

        sho.setBackground(new java.awt.Color(0, 0, 0));
        sho.setFont(new java.awt.Font("Arial Black", 0, 14)); // NOI18N
        ...
        while(rs.next()){
            ...
            String PHONE= rs.getString("PHONE");
             String OID= rs.getString("OID");
               ...
               String tbData[]={VID,NAME,CITY,PHONE,OID};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vtable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
